...
class Enemy {
    ...
    update(dt) {
        ...
        if( this.xMove > 500) {
            this.xMove = this.xMove - 500 - cell.width;
            this.speed = 50 + Math.floor(Math.random() * 100);
        }
        if(player.x < this.xMove + cell.width    &&
...
const enemy1 = new Enemy(0, 230, 20);
const enemy2 = new Enemy(101, 145, 30);
const enemy3 = new Enemy(0, 60, 35);
