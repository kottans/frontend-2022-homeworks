...
renderModal('You are welcome, my friend ! Wanna play some memory game to endure your mind and become more powerfull ? Try to find pairs of cards as fast as you can! Tap the button to begin... ', 'START THE GAME')
...
function renderModalAfterWin() {
    renderModal('Good job my friend! You became even stronger! Want to start one more time?', 'RESET')
}
