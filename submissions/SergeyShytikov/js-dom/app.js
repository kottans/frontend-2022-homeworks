const mtbCategories = [
  ...
  {
    name: "Freeride",
    description: "Freeride makes for an incredible spectacle, with riders performing huge jumps, flips, tricks while riding on more natural terrain - such as the dramatic red rocks and cliffs of Zion National Park in Utah, USA where the Red Bull Rampage event takes place. ",
    image: "assets/freeride.jpg"
  },
  {
    name: "Slopestyle",
    description: "Closely related to freeride, slopestyle is all about demonstrating aerial tricks on a specially designed course of huge ramps, drops, jumps and berms. In fact, the clue is in the name; how much style can a rider demonstrate while heading down the slope.",
  ...
  {
    name: "Dirt Jumping",
    description: "Is the practice of riding bikes over jumps made of dirt or soil and becoming airborne.",
