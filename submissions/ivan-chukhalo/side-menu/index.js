...
const classesArr = [
  ...
  function printClassInformation(event) {
    ...
    const contentLinkHome = document.querySelector('.content__link_back');
    ...
    if (el.name === className) {
      ...
      contentImg.setAttribute("src","./assets/illustrations/" + menuItem.innerText + ".jpg");
...
function resetContent(event){
  if (event.target.className==='content__link_back'){
    ...
    updatedImage.setAttribute('class', 'content__img');
    updatedImage.setAttribute('id', 'content__img');
    updatedImage.setAttribute('src', '');
    updatedImage.setAttribute('alt', '');

    const updatedLink = document.createElement('a');
    updatedLink.setAttribute('class', 'content__link_back');
    updatedLink.setAttribute('class', 'content__link_back');
    updatedLink.setAttribute('href', '');
    
    content.replaceChildren();
    content.appendChild(updatedTitle);
    content.appendChild(updatedDescription);
    content.appendChild(updatedImage);
    content.appendChild(updatedLink);
  }
}
