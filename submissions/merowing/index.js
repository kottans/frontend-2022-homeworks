const defaultFruits = ['fruit-1', 'fruit-2', 'fruit-3', 'fruit-4', 'fruit-5', 'fruit-6', 'fruit-7', 'fruit-8', 'fruit-9', 'fruit-10', 'fruit-11', 'fruit-12', 'fruit-13', 'fruit-14', 'fruit-15', 'fruit-16', 'fruit-17', 'fruit-18', 'fruit-19', 'fruit-20'];
...
function game() {
    ...
    if(maxFruits < defaultFruits.length) {
        ...
        if(number + maxFruits > defaultFruits.length) {
            ...
            randomFruits = [...defaultFruits.splice(number, num1), ...defaultFruits.splice(0, num2)];
        }else {
    ...
    for(let i = 0; i < maxFruits * counts; i++) {
        ...
        if(fruitsOnTheTable.filter(item => item === fruit).length <= counts - 1) {
            fruitsOnTheTable.push(fruit);
        }else {
