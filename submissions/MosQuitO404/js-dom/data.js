const alfaRomeo = {
    teamTitle: 'alfa-romeo',
    firstPilotName: 'Valtteri Bottas',
    secondPilotName: 'Zhou Guanyu',
    firstPilotFlagImage: './teams_img/flags/finland.gif', 
    secondPilotFlagImage: './teams_img/flags/china.jpg',
    firstPilotImage: './teams_img/teams_pilots/alfa-romeo/Valtteri-Bottas.jpg',
    secondPilotImage: './teams_img/teams_pilots/alfa-romeo/Zhou-Guanyu.jpg',
    teamInfo: '<h3>In profile</h3><p>The name Alfa Romeo boasts Formula 1 connections dating back to the championship`s inception in 1950. Fast forward to the 21st century and Italian flare combines with Swiss sensibilities in a new era for the team formerly known as Sauber.</p><p>Having enjoyed considerable success in world sportscars, where he helped nurture the emerging talents of future F1 stars Michael Schumacher and Heinz-Harald Frentzen, Peter Sauber guided his eponymous squad into F1 in 1993.</p><p>The team has since established itself as a mainstay of the grid, becoming race winners under BMW`s brief ownership, and developing a well-earned reputation not only for producing competitive cars, but also for developing young drivers.</p>'
}
const alphaTauri = {
    teamTitle: 'alphatauri',
    firstPilotName: 'Pierre Gasly',
    secondPilotName: 'Yuki Tsunoda',
    firstPilotFlagImage: './teams_img/flags/france.gif',
    secondPilotFlagImage: './teams_img/flags/japan.jpg',
    firstPilotImage: './teams_img/teams_pilots/alphatauri/Pierre-Gasly.jpg',
    secondPilotImage: './teams_img/teams_pilots/alphatauri/Yuki-Tsunoda.jpg',
    teamInfo: '<h3>In profile</h3><p>Established in 2006 as a squad in which young drivers from Red Bull`s prodigious talent pool could cut their F1 teeth, AlphaTauri - originally named Toro Rosso - were formed from the ashes of the plucky Minardi team. Sebastian Vettel gave validity to the approach almost immediately, delivering a fairy-tale win in 2008, before going on to enjoy world championship success with parent team Red Bull Racing. Today the ethos of nurturing talent still holds true, though the Italian squad are no longer simply a "B team" but a constructor in their own right...</p>' 
}
const alpine = {
    teamTitle: 'alpine',
    firstPilotName: 'Fernando Alonso',
    secondPilotName: 'Esteban Ocon',
    firstPilotFlagImage: './teams_img/flags/spain.jpg',
    secondPilotFlagImage: './teams_img/flags/france.gif',
    firstPilotImage: './teams_img/teams_pilots/alpine/Fernando-Alonso.jpg',
    secondPilotImage: './teams_img/teams_pilots/alpine/Esteban-Ocon.jpg',
    teamInfo: '<h3>In profile</h3><p>Alpine may be a relatively new name to Formula 1, but Renault`s famous sportscar arm has plenty of motorsport heritage. The 2021 rebrand of the team marked the next step in Renault`s F1 revival, begun in 2016 with the takeover of the then-Lotus squad. Already race winners in their new guise, regular podiums and a tilt at the title must be their next target...</p>' 
}
const astonMartin = {
    teamTitle: 'aston-martin',
    firstPilotName: 'Sebastian Vettel',
    secondPilotName: 'Lance Stroll',
    firstPilotFlagImage: './teams_img/flags/germany.jpg',
    secondPilotFlagImage: './teams_img/flags/canada.jpg',
    firstPilotImage: './teams_img/teams_pilots/aston-martin/Sebastian-Vettel.jpg',
    secondPilotImage: './teams_img/teams_pilots/aston-martin/Lance-Stroll.jpg',
...
const williams = {
    teamTitle: 'williams',
    firstPilotName: 'Nicholas Latifi',
    secondPilotName: 'Alexander Albon',
    firstPilotFlagImage: './teams_img/flags/canada.jpg',
    secondPilotFlagImage: './teams_img/flags/thailand.png',
    firstPilotImage: './teams_img/teams_pilots/villiams/Nicholas-Latifi.jpg',
    secondPilotImage: './teams_img/teams_pilots/villiams/Alexander-Albon.jpg',
    teamInfo: '<h3>In profile</h3><p>Driven on by the brilliance and passion of the late Sir Frank Williams, Williams grew from humble beginnings to become a Formula 1 behemoth, unrivalled by all except Ferrari and McLaren in terms of enduring success. Over the past four decades the team has racked up Grand Prix wins and championship glory, and in the process nurtured some of the greatest talents in the sport, both in and out the cockpit. Now, following the Williams family`s decision to step aside after the sale of the team to Dorilton Capital, a new era begins...</p>'
}

export
const teamsData = [alfaRomeo, alphaTauri, alpine, astonMartin, ferrari, haas, mcLaren, mercedes, redBull, williams];

export
const teamsProperties = ['teamTitle', 'firstPilotName', 'secondPilotName', 'firstPilotFlagImage', 'secondPilotFlagImage', 'firstPilotImage', 'secondPilotImage', 'teamInfo'];
