const houses = [
    ...
    },
    {
        ...
        content:{
            ...
            about: "Опис: Аррени — один з великих будинків Вестероса. Вони правлять у Долині Арренів тисячу років.",
    ...
    },
    {
        ...
        content:{
            ...
            about: "Опис: Дуже стародавній рід, вважається, що їх родовід не переривався з часів Брандона Будівельника, який жив десь вісім тисяч років тому. Як і багато інших домів Півночі, вони зберегли віру в Старих Богів.",
    ...
    },
    {
        ...
        content:{
            ...
            about: "Опис: Правителі Річкових земель, правлять з родового замку Ріверран, на чолі якого стоїть лорд Ріверрана. На даний момент це Едмур Таллі.",
    ...
    },
    {
        ...
        content:{
            ...
            about: "Опис: Мартелли — одна із шляхетних родин Вестероса. Вони правлять південним регіоном на континенті, Дорном, з замку Сонячний Спис.",
    ...
    },
    {
        ...
        content:{
            ...
            history: "Історія: Будинок Грейджоїв походить від Сірого Короля, легендарного Короля Залізних островів. Згідно з повір'ями, він правив тисячу років і взяв за дружину русалку. Як і більшість залізнонароджених, вони вірять у Бога, що потонув. На момент початку Війни п'яти королів на чолі будинку був Бейлон Грейджой. За вісім років до подій Війни п'яти королів він підняв повстання проти влади Залізного трону. Повстання закінчилося для Бейлона поразкою, двоє його синів, Родрік і Марон, загинули. Третього сина, Теона, взяв у заручники Еддард Старк, його відвезли у замок Вінтерфелл, де виховувався і навчався разом із дітьми Старка. Поруч із Бейлоном залишилася лише дочка Яра." 
        },
    },
    {
        name: "Тірелли",
