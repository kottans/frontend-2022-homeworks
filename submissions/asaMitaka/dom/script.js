...
let arrOfDatas = [
    {
        ...
        source: `https://open.spotify.com/embed/album/4Uv86qWpGTxf7fU7lG5X6F?utm_source=generator`,
        class: 'colledge'
    },
    {
        ...
        source: `https://open.spotify.com/embed/album/5ll74bqtkcXlKE7wwkMq4g?utm_source=generator`,
        class: 'late'
    },
    {
        title: 'Graduation',
        ...
        alt: 'Graduation',
        source: `https://open.spotify.com/embed/album/4SZko61aMnmgvNhfhgTuD3?utm_source=generator`,
        class: 'graduation'
    },
    {
        ...
        source: `https://open.spotify.com/embed/album/3WFTGIO6E3Xh4paEOBY9OU?utm_source=generator `,
    ...
    },
    {
        ...
        alt: 'MBDTF',
        source: `https://open.spotify.com/embed/album/20r762YmB5HeofjMCiPMLv?utm_source=generator`,
        class: 'mbdtf'
    },
    {
        title: 'Yeezus',
        ...
        alt: 'Yeezus',
        source: `https://open.spotify.com/embed/album/7D2NdGvBHIavgLhmcwhluK?utm_source=generator`,
        class: 'yeezus'
    },
    {
        ...
        alt: 'TLOP',
        source: `https://open.spotify.com/embed/album/7gsWAHLeT0w7es6FofOXk1?utm_source=generator`,
        class: 'tlop'
    },
    {
        title: 'Ye',
        ...
        alt: 'Ye',
        source: `https://open.spotify.com/embed/album/2Ek1q2haOnxVqhvVKqMvJe?utm_source=generator`,
        class: 'ye'
    },
    {
        title: 'Jesus Is King',
        ...
        alt: 'JiK',
        source: `https://open.spotify.com/embed/album/0FgZKfoU2Br5sHOfvZKTI9?utm_source=generator`,
        class: 'jis'
    },
    {
        title: 'Donda',
        ...
        alt: 'Donda',
        source: `https://open.spotify.com/embed/album/5CnpZV3q5BcESefcB3WJmz?utm_source=generator`,
        class: 'donda'
    }
];
...
function addToMain(item) {
    ...
    main.innerHTML = `
        ...
        <div class='mainSource'>
            <iframe style="border-radius:12px" src=${item.source} width="100%" height="80" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>
        </div>
    `;
