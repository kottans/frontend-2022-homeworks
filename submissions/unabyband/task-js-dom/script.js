...
const mainContent = {
    ...
    imgContent: [
      '<img src="src/bright_sun.jpg" alt="Clear Sky">',
  ...
  for (let i = 0; i < mainContent.sideTab.length; i++) {
    document.querySelector(mainContent.sideTab[i]).onclick = function () {
      document.querySelector(".content").innerHTML =
        '<span class="inner-text">' +
        mainContent.imgContent[i] +
        "<br>" +
        mainContent.textContent[i] +
        "</span>";
      document.querySelector(".content").style = mainContent.colorContent[i];
    };
  }
